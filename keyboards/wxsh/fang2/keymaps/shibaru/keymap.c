...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLE] = LAYOUT(
                 ...
                 KC_LCTRL, KC_Z,    KC_X,    KC_C,     KC_D,     KC_V,     KC_MUTE, XXXXXXX,               XXXXXXX, KC_MUTE, KC_K,    KC_H,     KC_COMM, KC_DOT,  KC_SLASH, TG(_GAMING),
                                             XXXXXXX,  KC_LGUI,  KC_TGLHR, KC_LALT, XXXXXXX,               XXXXXXX, KC_LSFT, KC_TGLS, KC_TGLSE, XXXXXXX 
    ),
    [_SPEC] = LAYOUT(
                 ...
                 _______, XXXXXXX,    XXXXXXX,  KC_BSLS,  KC_QUES,   XXXXXXX,     _______, _______,         _______, _______, XXXXXXX, KC_PLUS, KC_PIPE, XXXXXXX,  _______, _______,
    ...
    [_SEC] = LAYOUT(
                 _______, _______, _______,  _______,  _______, _______,  _______, 		                       _______, _______, _______, _______, _______,  _______,  _______,
                 _______, _______, _______,  _______,  _______, _______,  _______,                              _______, _______, _______, _______, _______,  _______,  _______,
                 _______, KC_AE,   KC_OE,    KC_AA,    _______, _______,                                        _______, KC_LEFT, KC_DOWN,  KC_UP,   KC_RIGHT, _______,
                 _______, _______, _______,  _______,  _______, _______,  _______, _______,            _______, _______, _______, _______, _______, _______, _______,  _______,
                                             _______,  _______, _______,  _______, _______,            _______, _______, XXXXXXX, _______, _______
    ),
    [_GAMING] = LAYOUT(
